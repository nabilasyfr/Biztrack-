            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="your@email.com"
                           value="<?php echo e(old('email')); ?>" required autofocus style="border-radius:0 10px 10px 0;">
                </div>
            </div>
            <div class="mb-4">
...
<?php /**PATH C:\xampp\htdocs\biztrack\resources\views/auth/login.blade.php ENDPATH**/ ?>