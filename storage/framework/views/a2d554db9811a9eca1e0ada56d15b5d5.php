...
<div class="page-header">
    <div>
        <h1>Jurnal Umum</h1>
        <p>
            Pencatatan transaksi non-operasional dan jurnal manual
            yang tidak berasal dari transaksi penjualan maupun pembelian.
        </p>
    </div>

    <div class="d-flex gap-2">
        <a href="<?php echo e(route('accounting.modal')); ?>" class="btn btn-primary">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <div>
            ...
            Entri Jurnal (<?php echo e($entries->total()); ?>)
        </div>

        <small class="text-muted">
            General Journal Entries (JRN)
        </small>
    </div>
            ...
            <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div>
                    ...
                    <div class="text-muted mt-1"
                        ...
                        <?php echo e(\Carbon\Carbon::parse($entry->entry_date)->format('d F Y')); ?>
                ...
                <tbody>
                    ...
                    <tr class="table-light fw-bold">
                        ...
                        <td class="text-end text-primary">
                            Rp<?php echo e(number_format($entry->lines->sum('debit'),0,',','.')); ?>

                        </td>

                        <td class="text-end text-success">
                            Rp<?php echo e(number_format($entry->lines->sum('credit'),0,',','.')); ?>
