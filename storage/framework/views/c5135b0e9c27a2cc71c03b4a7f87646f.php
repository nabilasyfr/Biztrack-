...
<body>
    <div>
        <div class="receipt">
            ...
            <div class="info-row"><span class="label">No. Invoice</span><strong><?php echo e($sale->invoice_number); ?></strong></div>
            <div class="info-row"><span class="label">Tanggal</span><span><?php echo e($sale->created_at->format('d/m/Y H:i')); ?></span></div>
            <div class="info-row"><span class="label">Kasir</span><span><?php echo e($sale->user->name ?? '-'); ?></span></div>
            <div class="info-row"><span class="label">Pembayaran</span><span class="payment-badge"><?php echo e(strtoupper($sale->payment_method)); ?></span></div>
            ...
            <div class="item-row">
                <div class="item-name">
                    <div><?php echo e($item->product->name ?? 'Produk'); ?></div>
                    <div class="item-detail"><?php echo e($item->quantity); ?> × Rp<?php echo e(number_format($item->unit_price,0,',','.')); ?></div>
                </div>
            ...
            <div class="total-row">
                <span>TOTAL</span>
                <span>Rp<?php echo e(number_format($sale->total_amount,0,',','.')); ?></span>
            </div>
            <?php if($sale->payment_method === 'cash'): ?>
            <div class="info-row"><span class="label">Diterima</span><span>Rp<?php echo e(number_format($sale->cash_received,0,',','.')); ?></span></div>
            <div class="change-row"><span>Kembalian</span><span>Rp<?php echo e(number_format($sale->change_amount,0,',','.')); ?></span></div>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\biztrack\resources\views/sales/receipt.blade.php ENDPATH**/ ?>